...
$current_file = PATH_APP.'/phproad/modules/db/behaviors/partials/'.$file_name;
$replacement_file = PATH_APP.'/modules/core/updates/framework/phproad/modules/db/behaviors/partials/'.$file_name;
